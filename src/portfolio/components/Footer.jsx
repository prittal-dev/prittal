...
export default function Footer({ setActiveTab, navigateTo, onNavigate }) {
  ...
  const portfolioQuickLinks = [
    { name: 'All Work', filter: 'Archive' },
    { name: 'Websites', filter: 'Websites' },
    { name: 'Branding', page: 'service-branding' },
    { name: 'AI Creative', filter: 'AI Video' },
  ...
  const handleLinkClick = (link) => {
    ...
    if (link.page && navigateTo) {
      navigateTo(link.page);
      return;
    }
    if (link.filter) {
      if (setActiveTab) setActiveTab('work');
      if (navigateTo) {
        navigateTo('portfolio-archive', link.filter);
      } else if (onNavigate) {
        onNavigate('#work');
      }
    }
        ...
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-8 pb-10 border-b border-white/15">
          ...
          <div className="col-span-1 lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium text-white/75">
              {portfolioQuickLinks.map((link, idx) => (
                <li key={idx}>
                  <button
          ...
          <div className="col-span-2 lg:col-span-3 space-y-3 pt-4 lg:pt-0">
            ...
            <div className="space-y-1.5 pt-1 border-t border-white/15 text-xs font-montserrat">
              ...
              <div className="flex items-center justify-between py-1 border-b border-white/10">
                ...
                <a 
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=sales@prittal.com&su=Inquiry%20from%20Portfolio%20-%20Prittal&body=Hi%20Prittal%20Team%2C%0A%0AI%20would%20like%20to%20know%20more%20about%20your%20services." 
                  target="_blank" 
                  rel="noopener noreferrer" 
